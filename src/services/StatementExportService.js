...
function buildHtmlStatement(expenses, metrics, isWord = false) {
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Zero Friction — Official Financial Statement</title>
      ${wordXml}
      <style>
        @page {
          size: A4;
    ...
    <body>
      <div class="header-card">
        <div class="brand-title">Zero Friction — Official Financial Statement</div>
      ...
      <div class="footer">
        Confidential Document · Generated by Zero Friction Financial OS<br/>
...
export async function exportPdfStatement() {
  try {
    ...
    await Sharing.shareAsync(uri, {
      ...
      dialogTitle: 'Share Zero Friction PDF Financial Statement',
    });
...
export async function exportWordStatement() {
  try {
    ...
    const docPath = FileSystem.documentDirectory + 'ZeroFriction_Statement.doc';
    ...
    await Sharing.shareAsync(docPath, {
      ...
      dialogTitle: 'Share Zero Friction Word Financial Statement',
    });
